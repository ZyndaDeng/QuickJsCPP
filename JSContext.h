...
protected:
    ...
    int JS_ToInt64Free(int64_t *pres, JSValue val);
    int JS_ToInt64Sat(int64_t *pres, JSValueConst val)
    {
        return JS_ToInt64SatFree(pres, JS_DupValue(val));
    }
    int JS_ToInt64SatFree(int64_t *pres, JSValue val);
#ifdef CONFIG_BIGNUM
